...
# ReplayBuffer, CNNFeatureExtractor, QNet 클래스는 동일
class ReplayBuffer:
...
class DQNAgent:
    def __init__(self, device='cpu'):
        self.gamma = 0.98
        self.lr = 0.0005
        self.epsilon = 1.0  # 초기에 높은 값으로 설정
        self.epsilon_decay_rate = 0.9995  # decay rate
...
for episode in range(episodes):
    ...
    if episode % 10 == 0:
        ...
        print(f"[{current_time}] Episode {episode}, Total Reward: {total_reward}, Epsilon: {agent.epsilon:.4f}")
